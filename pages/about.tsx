        ...
        <div className="grid md:grid-cols-2 gap-x-12 gap-y-16 items-start">
          <div className="space-y-3">
            ...
            <p className="rationale-text">
              With clinicians in public hospitals often seeing over 100 patients
              a day, the pressure is immense. This environment amplifies the
              risk of cognitive biases, where atypical presentations of endemic
              diseases like Tuberculosis can be missed. Over 80% of Indian
              doctors report burnout, a direct consequence of this systemic
              strain.
            </p>
            ...
            <p className="supporting-text">
              Source: Indian Medical Association (IMA), Published Studies 2024
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="rationale-text">
              In a high-volume Out-Patient Department (OPD), every minute
              counts. Even minimal time per patient on paperwork accumulates,
              leading to significant administrative overload. This non-clinical
              work reduces crucial interaction time and is a key factor that 45%
              of Indian doctors wish to decrease, allowing them to focus on
              clinical reasoning.
            </p>
            ...
            <p className="supporting-text">
              Source: Journal of Family Medicine and Primary Care, 2023
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="solution" className="max-w-4xl mx-auto mb-20 md:mb-28">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="output-box">
            ...
            <p>
              Aids in differentiating complex presentations, such as acute
              febrile illnesses (Dengue vs. Malaria vs. Typhoid) or the nuances
              of chest pain, ensuring critical possibilities are not overlooked
              in a high-pressure OPD.
            </p>
          </div>
          <div className="output-box">
            <h4>Structured Clinical Inquiry</h4>
            <p>
              Guides users to ask high-yield follow-up questions to
              systematically rule out red-flag symptoms for conditions prevalent
              in India, from cardiovascular events in younger adults to
          ...
          <div className="output-box">
            ...
            <p>
              Generates draft management plans aligned with national guidelines
              (e.g., NCDC, ICMR), emphasizing critical safety instructions like
              NSAID avoidance in Dengue and correct antibiotic stewardship.
            </p>
          </div>
          <div className="output-box">
            <h4>Automated Documentation</h4>
            <p>
              Leverages Natural Language Processing (NLP) to structure patient
              encounters into draft H&P notes, specifically designed to reduce
              the documentation burden in high-volume Indian hospital and clinic
              settings.
            </p>
          </div>
        </div>
